...
describe('MFE Example App', () => {
  ...
  describe('Component Rendering', () => {
    it('should render the main heading and description', () => {
      ...
      expect(
        screen.getByText('Interactive demonstration of all available MFE services and capabilities')
      ).toBeInTheDocument();
    });
  ...
  describe('Event Bus', () => {
    ...
    it('should emit MFE_UNLOADED event on unmount', () => {
      ...
      expect(mockServices.eventBus.emit).toHaveBeenCalledWith(EVENTS.MFE_UNLOADED, {
        name: 'example',
      });
    });
    ...
    it('should send custom event with valid JSON data', async () => {
      ...
      expect(mockServices.eventBus.emit).toHaveBeenCalledWith('CUSTOM_EVENT', { test: 'data' });
      expect(mockServices.notification.success).toHaveBeenCalledWith(
        'Event Sent',
  ...
  describe('Layout and Styling', () => {
    ...
    it('should have consistent button styling', () => {
      ...
      const modalButtons = screen
        .getAllByRole('button')
        .filter((btn) => btn.textContent?.includes('Modal'));
