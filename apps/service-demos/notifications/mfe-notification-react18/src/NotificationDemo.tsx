  ...
  const notificationTypes: NotificationConfig[] = [
    {
      ...
      message: 'This is a success notification example from React 18',
      icon: '✓',
    ...
    },
    {
      ...
      message: 'This is an error notification example from React 18',
      icon: '⚠',
    ...
    },
    {
      ...
      message: 'This is a warning notification example from React 18',
      icon: '⚠',
    ...
    },
    {
      ...
      message: 'This is an info notification example from React 18',
      icon: 'ℹ',
  ...
  return (
    <div className="ds-p-4">
      ...
      <div className="ds-flex ds-justify-between ds-items-center ds-mb-6">
        <h2 className="ds-section-title">React 18 Notifications</h2>
      ...
      <div className="ds-mt-6 ds-p-4 ds-bg-surface ds-rounded-lg ds-border">
        <p className="ds-text-sm ds-text-muted">
          This MFE demonstrates the notification service working with React 18. 
          Although labeled as React 18, it uses the shared React instance from the container's import map (React {React.version}). 
          All notifications are handled by the container's notification service.
        </p>
      </div>
    </div>
  );
