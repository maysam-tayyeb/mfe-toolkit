...
export const App: React.FC<AppProps> = ({ notification, logger }) => {
  ...
  const showSuccess = () => {
    showNotification(
      'Success!',
      'Operation completed successfully from React 17 MFE',
      'success'
    );
  };
  ...
  const showError = () => {
    showNotification(
      'Error Occurred',
      'Something went wrong in the React 17 MFE',
      'error'
    );
  };
  ...
  const showWarning = () => {
    showNotification(
      'Warning',
      'Please review this warning from React 17',
      'warning'
    );
  };
  ...
  const showInfo = () => {
    showNotification(
      'Information',
      'This is an informational message from React 17',
      'info'
    );
  };
  ...
  const showMultiple = () => {
    const messages = [
      { title: 'First', message: 'React 17 notification 1', type: 'info' as const },
      { title: 'Second', message: 'React 17 notification 2', type: 'success' as const },
      { title: 'Third', message: 'React 17 notification 3', type: 'warning' as const },
      { title: 'Fourth', message: 'React 17 notification 4', type: 'error' as const },
      { title: 'Fifth', message: 'React 17 notification 5', type: 'info' as const }
    ];
  ...
  return (
    <div className="ds-p-4">
      <div className="ds-mb-6">
        <h2 className="ds-text-2xl ds-font-bold ds-mb-2">React 17 Notification Demo</h2>
        <p className="ds-text-gray-600">
          Framework: <span className="ds-font-medium">React 17.0.2</span> | 
