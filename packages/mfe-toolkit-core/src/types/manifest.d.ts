 ...
 */
export declare function isMFEManifestV2(manifest: MFEManifest): manifest is MFEManifestV2;
/**
 * Type guard to check if manifest is V1
 */
export declare function isMFEManifestV1(manifest: MFEManifest): manifest is MFEManifestV1;
/**
